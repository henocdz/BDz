<?
	/*
		Realizada por: Henoc D�az (@roofdier)
		�ltima modificaci�n: Diciembre'06 2011
		M�xico, DF.
	*/
	...
	class bd
	{
		...
		{				
			...
			$this->password = "" // Constraseña para acceder a la base de datos;
			$this->host = "" // Servidor donde está alojada la base de datos;
			$this->status = "" // Vacio;
		...
		// Verificar si existe un registro seg�n par�metros
		...
		{
			$tor = false;
			list($d1,$m1,$y1) = explode("-",$ddb); // Fecha de la m�quina
